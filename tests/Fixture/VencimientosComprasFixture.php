...
/**
 * VencimientosComprasFixture
 *
 */
class VencimientosComprasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_vencimientos_compras_1_idx' => ['type' => 'index', 'columns' => ['id_compra'], 'length' => []],
            'fk_vencimientos_compras_2_idx' => ['type' => 'index', 'columns' => ['id_proveedor'], 'length' => []],
            'fk_vencimientos_compras_3_idx' => ['type' => 'index', 'columns' => ['id_empresa'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_vencimientos_compras_1' => ['type' => 'foreign', 'columns' => ['id_compra'], 'references' => ['compras', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_vencimientos_compras_2' => ['type' => 'foreign', 'columns' => ['id_proveedor'], 'references' => ['proveedores', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_vencimientos_compras_3' => ['type' => 'foreign', 'columns' => ['id_empresa'], 'references' => ['empresas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
